...
const DescSection = () => {
  ...
  return (
    <div className='desc'>
      <div className='top'>
        <div className='switcher'><div className={`userbtn ${mode == "user" ? "active" : ""} `} onClick={() => { setMode("user") }}>User</div>
          <div className={`gurubtn ${mode == "guru" ? "active" : ""} `} onClick={() => { setMode("guru") }}>Guru</div></div></div>
