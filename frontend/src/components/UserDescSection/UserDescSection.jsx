...
const UserDescSection = () => {
  return (
    <div className='desc_section-container'>
        <LeftDesc title="Pocket Friendly" text="You don’t have to buy any plan or subscription to use our services. We provide an easy pay-per-minute service." image1={Image3} image2={Image4} />
