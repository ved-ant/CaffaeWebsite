      ...
      <div className={stl.parent}>
        <div className={stl.left}>
          ...
          <div className={stl.matter}>
            ...
            college.</div>
            <br></br>
           <div className={stl.matter}> My desire to gain firsthand insights from current college
            ...
            of content, as she aimed to launch her own YouTube channel. These experiences led me to recognize a broader demand for trusted and
            individualized guidance. </div>
            <br> 
            </br>
            <div className={stl.matter}>This realization gave birth to the concept of
            ...
            of obtaining reliable information and advice effortless.</div>
        </div>
